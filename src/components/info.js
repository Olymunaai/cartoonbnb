const info = [
  {
    ...
    description:
      "Gravity Falls offers a range of magical creatures and strange happenings. There's always an adventure to be had!",
    ...
    bulletpoints: [
      ...
      "consectetur adipiscing elit. Integer sit.",
      "Lorem ipsum dolor sit amet, consectetur adipiscing.",
      "Neque porro quisquam est qui.",
      "ipsum quia dolor sit amet, consectetur, adipisci velit.",
      "Lorem ipsum dolor sit amet.",
  ...
  },
  {
    ...
    rating: "4.3",
    name: "Evergreen Terrace, Springfield",
    description:
      "Romantic getaway, charming neighbour and boys-only treehouse.",
    extended: `Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent consequat, metus nec mattis lacinia, magna massa dignissim augue, sed euismod leo arcu vel nibh. Praesent sit amet fringilla mi, ac luctus neque. Aliquam vel eleifend nisi, vitae euismod ante. Nulla lobortis nibh id commodo sollicitudin. Fusce at purus diam. Curabitur ornare rhoncus tristique. Cras scelerisque in sem vitae cursus. Duis luctus elit eu nisi hendrerit, vel euismod quam facilisis.

    Mauris tristique mauris at placerat viverra. Donec at tempor erat. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Fusce vel dolor lacus. Duis laoreet ante ex, vel dapibus turpis aliquam at. Donec ligula turpis, lacinia vitae lacus vel, maximus sodales purus. Sed volutpat bibendum fringilla. Nullam purus risus, vehicula at varius id, gravida nec justo. Cras lacus nulla, commodo id malesuada in, scelerisque sit amet lacus.`,
    price: "£87 /night",
    bulletpoints: [
      "Mauris et tellus eget libero fringilla aliquam.",
      "Neque porro quisquam est qui.",
      "ipsum quia dolor sit amet, consectetur, adipisci velit.",
      "Sed pulvinar fringilla ullamcorper.",
      "Quisque aliquet auctor tortor molestie cursus.",
      "ipsum quia dolor sit amet, consectetur, adipisci velit.",
      "Lorem ipsum dolor sit amet.",
      "ipsum quia dolor sit amet, consectetur, adipisci velit.",
      "Sed pulvinar fringilla ullamcorper.",
  ...
  },
  {
    ...
    rating: "3.8",
    name: "Spooner Street, Quahog",
    description:
      "With scenes such as the pawtucket brewry and the Drunken Clam, there's something for everyone.",
    extended: `Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent consequat, metus nec mattis lacinia, magna massa dignissim augue, sed euismod leo arcu vel nibh. Praesent sit amet fringilla mi, ac luctus neque. Aliquam vel eleifend nisi, vitae euismod ante. Nulla lobortis nibh id commodo sollicitudin. Fusce at purus diam. Curabitur ornare rhoncus tristique. Cras scelerisque in sem vitae cursus. Duis luctus elit eu nisi hendrerit, vel euismod quam facilisis.
  ...
  },
  {
    ...
    description:
      "Nothing is impossible in this beautiful getaway, it's complete with subterrainian lair and garage-lab.",
    extended: `Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent consequat, metus nec mattis lacinia, magna massa dignissim augue, sed euismod leo arcu vel nibh. Praesent sit amet fringilla mi, ac luctus neque. Aliquam vel eleifend nisi, vitae euismod ante. Nulla lobortis nibh id commodo sollicitudin. Fusce at purus diam. Curabitur ornare rhoncus tristique. Cras scelerisque in sem vitae cursus. Duis luctus elit eu nisi hendrerit, vel euismod quam facilisis.
    ...
    bulletpoints: [
      "Lorem ipsum dolor sit amet, consectetur adipiscing.",
      "Neque porro quisquam est qui.",
      "Nulla vitae turpis neque.",
      "Nam lobortis volutpat nisi, vel tempor mi elementum ut.",
      "Lorem ipsum dolor sit amet, consectetur adipiscing.",
      "Neque porro quisquam est qui.",
      "Nulla vitae turpis neque.",
      "Nam lobortis volutpat nisi, vel tempor mi elementum ut.",
  ...
  },
  {
    ...
    img: [
      ...
      "/img/fosters/fosters2.jpg",
      "/img/fosters/fosters3.jpg",
      "/img/fosters/fosters4.jpg",
      "/img/fosters/fosters5.jpg",
    ],
    rating: "4.1",
    name: "Fosters Home for Imaginary Friends",
    description:
      "Meet Bloo and the gang! This place is full of wacky imaginary friends, who are dying to play!",
    extended: `Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent consequat, metus nec mattis lacinia, magna massa dignissim augue, sed euismod leo arcu vel nibh. Praesent sit amet fringilla mi, ac luctus neque. Aliquam vel eleifend nisi, vitae euismod ante. Nulla lobortis nibh id commodo sollicitudin. Fusce at purus diam. Curabitur ornare rhoncus tristique. Cras scelerisque in sem vitae cursus. Duis luctus elit eu nisi hendrerit, vel euismod quam facilisis.
  ...
  },
  {
    ...
    name: "Land of Ooo",
    description:
      "Everyone is edible and everyone is all women are princesses - head on down to the Land of Ooo!",
    extended: `Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent consequat, metus nec mattis lacinia, magna massa dignissim augue, sed euismod leo arcu vel nibh. Praesent sit amet fringilla mi, ac luctus neque. Aliquam vel eleifend nisi, vitae euismod ante. Nulla lobortis nibh id commodo sollicitudin. Fusce at purus diam. Curabitur ornare rhoncus tristique. Cras scelerisque in sem vitae cursus. Duis luctus elit eu nisi hendrerit, vel euismod quam facilisis.
  ...
  },
  {
    ...
    name: "Halloween Town",
    description:
      "Can you survive a trip to Halloween Town? This one is only for the brave! Halloween parades, boogie men and more!",
    extended: `Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent consequat, metus nec mattis lacinia, magna massa dignissim augue, sed euismod leo arcu vel nibh. Praesent sit amet fringilla mi, ac luctus neque. Aliquam vel eleifend nisi, vitae euismod ante. Nulla lobortis nibh id commodo sollicitudin. Fusce at purus diam. Curabitur ornare rhoncus tristique. Cras scelerisque in sem vitae cursus. Duis luctus elit eu nisi hendrerit, vel euismod quam facilisis.
  ...
  },
  {
    ...
    img: [
      ...
      "/img/tangled/tangled2.jpg",
      "/img/tangled/tangled3.jpg",
      "/img/tangled/tangled4.jpg",
      "/img/tangled/tangled5.jpg",
    ],
    rating: "2.4",
    name: "Rapunzel's Tower",
    description:
      "It's nice to begin with, but gets a bit awkward when you're not allowed to leave. Don't go if you have magical healing hair.",
    extended: `Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent consequat, metus nec mattis lacinia, magna massa dignissim augue, sed euismod leo arcu vel nibh. Praesent sit amet fringilla mi, ac luctus neque. Aliquam vel eleifend nisi, vitae euismod ante. Nulla lobortis nibh id commodo sollicitudin. Fusce at purus diam. Curabitur ornare rhoncus tristique. Cras scelerisque in sem vitae cursus. Duis luctus elit eu nisi hendrerit, vel euismod quam facilisis.
